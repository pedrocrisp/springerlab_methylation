...
# cd ~/ws/analysis/ongoing/barley_mach3/analysis/Barley_leaf_S29_mC_domains_II_cov_3_sites_2_MR_0.4_UMR_0.1/mC_UMT_annotation_beds
# umr_bed_file=Barley_leaf_S29_mC_domains_cov_3_sites_2_MR_0.4_UMR_0.1.bed
# acr_bed_file=~/ws/analysis/ongoing/barley_mach3/Barley_7days_leaf_ACRs.bed
# chrom_sizes_file=~/ws/refseqs/barley/Hordeum_vulgare.Hv_IBSC_PGSB_v2.dna.toplevel.chrom.sizes.sorted
# summary_output_folder=~/ws/analysis/ongoing/barley_mach3/analysis/Barley_leaf_S29_mC_domains_II_cov_3_sites_2_MR_0.4_UMR_0.1/mC_UMT_annotation
...
R -f ~/gitrepos/springerlab_methylation/utils/92-overlap-tiles_groups-regions-R2.R \
