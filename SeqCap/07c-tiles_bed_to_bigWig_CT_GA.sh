...
########## Run #################
        ...
        perl ~/gitrepos/springerlab_methylation/SeqCap/met_context_window_CT_GA.pl ./BSMAPratio/${ID}_BSMAP_out.txt 100

        #move output into tiles folder
        mv -v ./BSMAPratio/${ID}_BSMAP_out.txt.100.*.bed ./tiles_CT_GA/
        ...
        R -f ~/gitrepos/springerlab_methylation/SeqCap/07c-tiles_bed_to_bigWig_CT_GA.R \
        --args ${ID} tiles_CT_GA ${reference_tile_file}
        ...
        bedGraphToBigWig "./tiles_CT_GA/${ID}_BSMAP_out.txt.100.CG.fixed.sorted.bg" ${chrom_sizes} \
        "./tiles/${ID}_BSMAP_out.txt.100.CG.bigWig"
        bedGraphToBigWig "./tiles_CT_GA/${ID}_BSMAP_out.txt.100.CHG.fixed.sorted.bg" ${chrom_sizes} \
        "./tiles/${ID}_BSMAP_out.txt.100.CHG.bigWig"
        bedGraphToBigWig "./tiles_CT_GA/${ID}_BSMAP_out.txt.100.CHH.fixed.sorted.bg" ${chrom_sizes} \
