...
my @files = qw | /home/springer/nosha003/schmitz/atacseq/counts/207_Leaf_uniq.bowtie.100bpcounts.bed
		 /home/springer/nosha003/schmitz/atacseq/counts/207_Root_uniq.bowtie.100bpcounts.bed
		 /home/springer/nosha003/schmitz/atacseq/counts/B73_Leaf_uniq.bowtie.100bpcounts.bed
		 /home/springer/nosha003/schmitz/atacseq/counts/B73_Root_uniq.bowtie.100bpcounts.bed
		 /home/springer/nosha003/schmitz/atacseq/counts/PHJ89_Leaf_rep1_uniq.bowtie.100bpcounts.bed
		 /home/springer/nosha003/schmitz/atacseq/counts/W22_Leaf_uniq.bowtie.100bpcounts.bed
...
foreach my $key (sort {$a cmp $b} keys %hoh) {
    my $a = $hoh{$key}{'207_Leaf'};
    my $b = $hoh{$key}{'207_Root'};
    my $c = $hoh{$key}{'B73_Leaf'};
    my $d = $hoh{$key}{'B73_Root'};
    my $e = $hoh{$key}{'PHJ89_Leaf_rep1'};
    my $f = $hoh{$key}{'W22_Leaf'};
    my $g = $hoh{$key}{'W22_Root_rep1'};
    
    print $matrix_out_fh "$key\t$a\t$b\t$c\t$d\t$e\t$f\t$g\n";   
}
close $matrix_out_fh;
exit;
