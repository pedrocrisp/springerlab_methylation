...
while (my $line = <$in_fh>) {
  ...
  if (!($x207_Leaf_rep1 eq "N/A")) {
    if (!($x207_Leaf_rep2 eq "N/A")) {
      ...
      $x207_Leaf2 = ($x207_Leaf / ((1166219 + 17072517)/2)) * 10000000;
    }
  }
  else {
    $x207_Leaf = 'N/A';
  ...
  if (!($x207_Root_rep1 eq "N/A")) {
    if (!($x207_Root_rep2 eq "N/A")) {
      ...
      $x207_Root2 = ($x207_Root / ((17309410 + 15585895)/2)) * 10000000;
    }
  }
  else {
    $x207_Root = 'N/A';
  ...
  if (!($B73_Leaf_rep1 eq "N/A")) {
    if (!($B73_Leaf_rep2 eq "N/A")) {
      ...
      $B73_Leaf2 = ($B73_Leaf / ((13589347 + 13296764)/2)) * 10000000;
  ...
  if (!($B73_Root_rep1 eq "N/A")) {
    if (!($B73_Root_rep2 eq "N/A")) {
      ...
      $B73_Root2 = ($B73_Root / ((26061771 + 10135372)/2)) * 10000000;
    }
  }
  else {
    $B73_Root = 'N/A';
  ...
  if (!($PHJ89_Leaf_rep1 eq "N/A")) {
    ...
    $PHJ89_Leaf2 = ($PHJ89_Leaf / (8785547)) * 10000000;
  ...
  if (!($W22_Leaf_rep1 eq "N/A")) {
    if (!($W22_Leaf_rep2 eq "N/A")) {
      ...
      $W22_Leaf2 = ($W22_Leaf / ((5595432 + 4209772)/2)) * 10000000;
    }
  }
  else {
    $W22_Leaf = 'N/A';
  ...
  if (!($W22_Root_rep1 eq "N/A")) {
    ...
    $W22_Root2 = ($W22_Root / (9067620)) * 10000000;
