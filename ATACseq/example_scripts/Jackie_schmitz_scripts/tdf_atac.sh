...
#PBS -o /scratch.global/nosha003/schmitz/e_o/tdf_atac_o
#PBS -e /scratch.global/nosha003/schmitz/e_o/tdf_atac_e
#PBS -N tdf_atac
#PBS -V
#PBS -r n
...
# qsub -t 1-12 -v LIST=/home/springer/nosha003/schmitz/scripts/atacseq_names.txt /home/springer/nosha003/schmitz/scripts/tdf_atac.sh